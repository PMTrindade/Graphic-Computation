...
function cylinderBuildFaces() {
	cylinderBuildCircle(0);
	cylinderBuildCircle(CYLINDER_N + 1);
...
function cylinderBuildCircle(offset) {
	var o = 0;

	for (var i = 0; i < CYLINDER_N; i++) {
		o = offset + i;
		cylinderAddTriangle(offset, o, o + 1);
	}

	cylinderAddTriangle(offset, o + 1, offset + 1);
}
